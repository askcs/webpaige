...
{	
	...
	//this.url = 'http://localhost:9000' + url;
	this.url = host + url;
	this.data=data;
...
//Render functions:
ASKCache.prototype.addRenderer = function(renderer,doRender)
{
...
ASKCache.prototype.render = function()
{
	...
	var page_list = this.renderers['dashboard.html'];
	if (page_list)
	{
		if (render_list)
		{
...
/*
	...
	{
*/
		var renderers = this.renderers['dashboard.html'];
		if (!renderers) return;
...
*/
	...
	var oldKey=this.session.sessionKey;
