...
function ask_slots_modal_update( from, till, reoc, value, efrom, etill, ereoc, evalue  )
{
  var ask_host = host;
  var ask_user = localStorage.getItem('loginUser');
  
  var resman = ask_host + '/askatars/' + ask_user + '/slots';
  var bodyJson = '{"color":null'+',"count":0'+',"end":'+till+',"recursive":'+reoc+',"start":'+from+',"text":"'+value+',"wish":0}';
  
  var queryJson = 'start='+efrom+'&end='+etill+'&text='+evalue+'&recursive='+ereoc;
