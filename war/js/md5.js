...
$(document).ready(function () {
	...
	if(window.localStorage) {
		...
		var login = localStorage.getItem("loginCredentials");
		if(login!=null){
	...
	$('.submit').click(function(){
		...
		var xhr = $.ajax({url: host+'/login?uuid='+user+'&pass='+MD5(pass),
				//dataType: 'jsonp',
				statusCode: {
					400: function() {alert("Username or password incorrect");window.location="login.html";}
				},
				xhrFields: {
